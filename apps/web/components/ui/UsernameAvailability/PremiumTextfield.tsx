      ...
      <div className="flex rounded-md">
        <span
          className={classNames(
            ...
            "border-default bg-muted text-subtle hidden h-8 items-center rounded-l-md border border-r-0 px-3 text-sm md:inline-flex max-w-32 truncate"
          )}
          title={process.env.NEXT_PUBLIC_WEBSITE_URL.replace("https://", "").replace("http://", "")}>
